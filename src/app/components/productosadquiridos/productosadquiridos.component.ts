...
@Component({
    selector: 'app-productosadquiridos',
    templateUrl: './productosadquiridos.component.html',
    styleUrls: ['./productosadquiridos.component.css']
})
export class ProductosadquiridosComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.client
            .getRequest(`${this.server}/api/v01/purchased/products/${this.token}/comprador`)
            .subscribe((res: any) => {
                this.listP = res;
                try {
                    this.infoProduct = {
